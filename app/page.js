    ...
    <div className="overflow-auto scroll-smooth" style={styling} >
      ...
      <div className="flex items-center justify-center h-screen mt-20">
        <div className="text-center mr-32">
          ...
          <div className="text-6xl font-mono "><ReactTyped strings={["Hi! I'm Rohan 👋", "A Software Engineer"]} typeSpeed={100} backSpeed={100} loop></ReactTyped></div>
        ...
        <div className="w-1/3 text-2xl bg-white rounded-lg mr-12 overflow-auto">
